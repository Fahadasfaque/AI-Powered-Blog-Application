    ...
    <div className="mx-8 sm:mx-16 xl:mx-24  relative  ">
      <div className="text-center mt-20 mb-8">
        ...
        <p className="my-6 sm:my-8 mx-w-2xl m-auto max-sm:text-xs text-gray-500 ">
          This is your space to think out loud, to share what matter, and to
      ...
      <div className="text-center">
        {input && (
          <button onClick={onClear} className=" border border-gray-950 font-bold text-xs py-1 px-3 rounded-sm shadow-primary cursor-pointer">
            Clear Search
          </button>
        )}
      </div>
